...
class TestElasticsearchService:
    ...
    def test_search_with_query(
        self, es_service, mock_elasticsearch_client, sample_search_response
    ):
    ...
    def test_search_with_single_db_and_photographer(
        self, es_service, mock_elasticsearch_client, sample_search_response
    ):
    ...
    def test_search_with_multiple_dbs_and_photographers(
        self, es_service, mock_elasticsearch_client, sample_search_response
    ):
    ...
    def test_search_with_empty_lists(
        self, es_service, mock_elasticsearch_client, sample_search_response
    ):
        """Test search with empty lists for db and photographer."""
        mock_elasticsearch_client.search.return_value = sample_search_response

        query_params = {"db": [], "photographer": [], "page": 1, "page_size": 20}
